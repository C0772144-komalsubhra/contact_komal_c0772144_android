...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    boolean addPerson(String first_name,String last_name ,String phone ,String email, String address){
    ...
    boolean updatePerson(int id,String first_name, String last_name, String phone,String email, String address){
        SQLiteDatabase sqLiteDatabase = getWritableDatabase();
